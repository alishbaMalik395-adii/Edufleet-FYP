...
export default function TrackingScreen() {
  ...
  const [buses, setBuses] = useState([
    { id: "B1", busNo: "BUS-01", route: "piplan,chashma→ Mianwali", lat: 33.6844, lng: 73.0479 }, // example coords
    { id: "B2", busNo: "BUS-02", route: "piplan,hernolimor → Mianwali", lat: 33.6890, lng: 73.0500 },
    { id: "B3", busNo: "BUS-03",  route: "kamarmoshani → Mianwali", lat: 33.6800, lng: 73.0400 },
    { id: "B4", busNo: "BUS-04",  route: "Kalabag→ Mianwali",  lat: 33.6905, lng: 73.0600 },
    { id: "B5", busNo: "BUS-05",  route: "Esakhail → Mianwali",  lat: 33.6750, lng: 73.0300 },
  ]);
